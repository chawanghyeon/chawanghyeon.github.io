...
Inference rule: A rule that draw another proposition and logic from some proposition
basically use logical equvaluation.
...
1. [Mathematical induction](https://en.wikipedia.org/wiki/Mathematical_induction)
2. [Direct proof(Deduction)](https://en.wikipedia.org/wiki/Direct_proof)
3. [Proof by contradiction](https://en.wikipedia.org/wiki/Proof_by_contradiction)
...
- [Floor and ceiling function](https://en.wikipedia.org/wiki/Floor_and_ceiling_functions)
...
- [Isomorphic graph](https://en.wikipedia.org/wiki/Graph_isomorphism)

- [Eulerian path](https://en.wikipedia.org/wiki/Eulerian_path)
- [Hamlitonian path](https://en.wikipedia.org/wiki/Hamiltonian_path)
